...
const customTheme = {
  root: {
    base: "bg-white px-4 py-5 sm:px-4 dark:border-gray-700 dark:bg-gray-800",
    rounded: {
      on: "rounded",
      off: "",
    },
...
const AppHeader: React.FC<AppHeaderProps> = ({
  ...
  return (
    <MegaMenu theme={customTheme} className="w-full col-span-4 relative">
      <NavbarBrand href="/">
      ...
      <div className="order-2 items-center gap-2 flex cursor-pointer">
        ...
        <Button className="cursor-pointer" onClick={onNewTaskClick}>
          New Task
        </Button>
      </div>
      {/* <NavbarToggle /> */}
      {dropdownOpen && (
        <div className="absolute top-16 right-16 mt-2 z-50">
          <AppDropdown />
        </div>
      )}
    </MegaMenu>
